...
int main( int argc, char** argv )
{
  ...
  general_opt.add_options()
    ...
    ("nx", po::value<double>()->default_value(0), "choose x comp of the normal vector." )
    ("ny", po::value<double>()->default_value(0), "choose y comp of the normal vector." )
    ("nz", po::value<double>()->default_value(1), "choose z  comp of the normal vector." )
    ("centerX,x", po::value<unsigned int>()->default_value(0), "choose x center of the projected first image." )
    ("centerY,y", po::value<unsigned int>()->default_value(0), "choose y center of the projected first image." )
    ("centerZ,z", po::value<unsigned int>()->default_value(1), "choose z center of the projected first image." )
