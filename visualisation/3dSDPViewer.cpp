...
int main( int argc, char** argv )
{
  ...
  general_opt.add_options()
    ...
    ("filter,f",po::value<int>()->default_value(100), "filter input file in order to display only the [arg] pourcent of the input 3D points (uniformly selected)." ) 
