...
int main( int argc, char** argv )
{
  ...
  if(!neededArgsGiven || !parseOK || vm.count("help") || argc <= 1 )
  {
    ...
    << "\t3dCurvatureViewerNoise -i file.vol --radius 5 --mode mean --noise 0.3"<<std::endl
    << std::endl
  ...
  KanungoPredicate noisifiedObject( predicate, domain, noiseLevel );
  Z3i::KSpace K;
  ...
  Surfaces<KSpace>::extractAllConnectedSCell(vectConnectedSCell,K, Sadj, noisifiedObject, false);
